package com.sirius.alipay.config;

import com.sirius.alipay.util.Keys;
import com.sirius.alipay.util.UtilDate;
...
public class AlipayConfig {
	...
	public static String alipayurl = "https://mapi.alipay.com/gateway.do";
	public static String appid = "2016052701448553";
	...
	private static String notify_url = "http://www.isonetech.com/pay/alipayRefund/{sonOrderNo}";

	public static String getNotify_url(String sonOrderNo) {
		return notify_url.replace("{sonOrderNo}", sonOrderNo);
	}
